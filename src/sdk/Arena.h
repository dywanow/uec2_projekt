...
private:
    ...
    static const uint16_t WALLS_NUMBER = 128;
    static const uint16_t BOXES_NUMBER = 128;
    ...
    static const uint16_t ELEMENTS_NUMBER = PATHS_NUMBER+WALLS_NUMBER+BOXES_NUMBER+BOMBERS_NUMBER+BOMBS_NUMBER+FIRES_NUMBER;
