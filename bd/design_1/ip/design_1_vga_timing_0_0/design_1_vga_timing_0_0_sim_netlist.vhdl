...
--               d:/AGH/sem4/cyfra2/uec2_projekt4/bd/design_1/ip/design_1_vga_timing_0_0/design_1_vga_timing_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of design_1_vga_timing_0_0_vga_timing is
  ...
  signal o_hblnk_INST_0_i_1_n_0 : STD_LOGIC;
  signal o_hsync_INST_0_i_1_n_0 : STD_LOGIC;
  signal o_hsync_INST_0_i_2_n_0 : STD_LOGIC;
  signal o_vblnk_INST_0_i_1_n_0 : STD_LOGIC;
  signal o_vblnk_INST_0_i_2_n_0 : STD_LOGIC;
  signal o_vblnk_INST_0_i_3_n_0 : STD_LOGIC;
  signal \^o_vcount\ : STD_LOGIC_VECTOR ( 11 downto 0 );
  signal o_vsync_INST_0_i_1_n_0 : STD_LOGIC;
  signal o_vsync_INST_0_i_2_n_0 : STD_LOGIC;
  signal vc : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of o_hsync_INST_0_i_2 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of o_vblnk_INST_0_i_2 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of o_vsync_INST_0 : label is "soft_lutpair0";
...
o_hblnk_INST_0: unisim.vcomponents.LUT6
    generic map(
...
o_hblnk_INST_0_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000007"
    )
        port map (
...
o_hsync_INST_0: unisim.vcomponents.LUT6
    generic map(
...
o_hsync_INST_0_i_1: unisim.vcomponents.LUT6
    generic map(
...
o_hsync_INST_0_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"BD"
    )
        port map (
...
o_vblnk_INST_0: unisim.vcomponents.LUT5
    generic map(
      INIT => X"03301131"
    )
        port map (
...
o_vblnk_INST_0_i_1: unisim.vcomponents.LUT6
    generic map(
...
o_vblnk_INST_0_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
o_vblnk_INST_0_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
o_vsync_INST_0: unisim.vcomponents.LUT5
    generic map(
      INIT => X"20002002"
    )
        port map (
...
o_vsync_INST_0_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"44000002"
    )
        port map (
...
o_vsync_INST_0_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFEF"
    )
        port map (
...
vc0_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      O(1) => vc0_carry_n_6,
      O(0) => vc0_carry_n_7,
      S(3 downto 0) => \^o_vcount\(4 downto 1)
    );
\vc0_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => \^o_vcount\(8 downto 5)
    );
\vc0_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => '0',
      S(2 downto 0) => \^o_vcount\(11 downto 9)
    );
...
inst: entity work.design_1_vga_timing_0_0_vga_timing
     port map (
      Q(11 downto 0) => o_hcount(11 downto 0),
      i_pclk => i_pclk,
      i_rst => i_rst,
      o_hblnk => o_hblnk,
      o_hsync => o_hsync,
