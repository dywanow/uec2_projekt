...
architecture STRUCTURE of design_1_clk_wiz_0_0_design_1_clk_wiz_0_0_clk_wiz is
  ...
  signal pclk_design_1_clk_wiz_0_0_en_clk : STD_LOGIC;
...
clkout2_buf_en: unisim.vcomponents.BUFH
     port map (
      ...
      O => pclk_design_1_clk_wiz_0_0_en_clk
    );
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    generic map(
      ...
      CLKOUT1 => pclk_design_1_clk_wiz_0_0,
...
\seq_reg2_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
        ...
        port map (
      C => pclk_design_1_clk_wiz_0_0_en_clk,
      CE => '1',
      CLR => reset,
      D => \^locked\,
      Q => seq_reg2(0)
